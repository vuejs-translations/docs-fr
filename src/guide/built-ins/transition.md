...
`<Transition>` peut également être utilisé autour des [composants dynamiques](/guide/essentials/component-basics.html#dynamic-components) :
...
- [`<Transition>` API](/api/built-in-components.html#transition)
