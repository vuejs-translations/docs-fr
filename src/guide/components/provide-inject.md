...
## Passage de props en profondeur (Prop Drilling) {#prop-drilling} {#prop-drilling}
...
## Provide au niveau de l'application {#app-level-provide} {#app-level-provide}
...
### Alias d'injection {#injection-aliasing} {#injection-aliasing}
...
### Valeurs par défaut lors de l'injection {#injection-default-values} {#injection-default-values}
...
## Injections réactives {#working-with-reactivity} {#working-with-reactivity}
...
## Injection avec des Symbols en tant que clés {#working-with-symbol-keys} {#working-with-symbol-keys}
