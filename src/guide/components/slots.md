...
> This page assumes you've already read the [principes fondamentaux des composants](/guide/essentials/component-basics). Read that first if you are new to components.
